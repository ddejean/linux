...
#ifdef CONFIG_BCM7401C0
	bcm3250_UARTA_device.id = 1;
	bcm3250_UARTB_device.id = 0;
#endif
...
#else /* CONFIG_DREAMBOX */

	first = 1; // just to make the compiler happy
	cs_info[1].type = TYPE_NAND;
